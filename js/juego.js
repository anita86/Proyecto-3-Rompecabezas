...
var instrucciones = [
  "Usá las flechas del teclado para mover las piezas",
  "Ordená las piezas hasta alcanzar la imagen objetivo"
];
// Arreglo para ir guardando los movimientos que se vayan realizando
var movimientos = [];

// Arreglo que contiene las intrucciones del juego
var tiempo = ("El tiempo corre!!");
...
// Representación de la grilla ganadora.
var grillaGanadora = [
  [1, 2, 3],
  [4, 5, 6],
  [7, 8, 9]
...
//Función que muestra el tiempo transcurrido desde que comienza el juego.
function mostrarTiempo() {
  var cartelTiempoConsumido = document.getElementById('tiempo-consumido').innerHTML = tiempo;

  var tiempoLimite = 30;

  var cuentaRegresiva = document.getElementById('temporizador');

  var tiempoConsumido = setInterval(function() {

    tiempoLimite--;

    cuentaRegresiva.innerHTML = tiempoLimite;
    if (tiempoLimite == 0) {
      clearInterval(tiempoConsumido);
      alert('Te quedaste sin tiempo. Intentá nuevamente!!');
      reiniciar();
    } else if (chequearSiGano() == true) {
      clearInterval(tiempoConsumido);
      reiniciar();
    }
  }, 1000);
...
function mostrarCartelGanador() {
  //COMPLETAR
  alert("Completaste el rompecabezas. Enhorabuena!!");
}
